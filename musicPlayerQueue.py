...
class songClass:
    def __init__(self, songID):
        ...
        songInfo = c.fetchall()[0]

        self.songName = songInfo[1]
        self.artistName = songInfo[2]
        self.currentHits = songInfo[7]

        self.song = self.songName  + ', ' + self.artistName
        self.filename = "images/albums/" + self.song + '.jpg'
        self.songPath = 'music/' + self.songName + '.mp3'
        

    def updateHits(self, c ,conn):
        c.execute('UPDATE songs SET hits = ? WHERE id = ?', (self.currentHits + 1, self.songID,))
        conn.commit()
        ...
        try:
            ...
            self.albumImage = self.filename
                ...
                try:
                        ...
                        results = sp.search(q=(self.songName + " " + self.artistName), limit=1)
                        ...
                        self.albumImage = "images/albumcover.png"
